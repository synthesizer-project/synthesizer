...
from synthesizer.utils.distributions import planck
...
class Blackbody(DustEmission):
    ...
    def _generate_spectra(
        ...
        # Normalise the blackbody spectrum using float64 integration
