...
from synthesizer.emission_models.tree_plot import _plot_emission_tree
    ...
    def plot_emission_tree(
        ...
        Args:
            ...
            node_size_factor (float):
                A factor to scale the node sizes by.
            edge_width (float):
                The width of the edges in the plot.
        """
        return _plot_emission_tree(
            self._models,
            root=root if root is not None else self.label,
            show=show,
            fontsize=fontsize,
            figsize=figsize,
