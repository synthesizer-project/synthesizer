...
class Galaxy(BaseGalaxy):
    ...
    def get_stellar_los_tau_v(
        ...
        """
        tic("Calculating stellar LOS tau_v")
        ...
        toc("Calculating stellar LOS tau_v")
    ...
    def get_black_hole_los_tau_v(
        ...
        Args:
            ...
            nthreads (int):
                The number of threads to use in the tree search. Default is 1.
        """
        tic("Calculating black hole LOS tau_v")
        ...
        toc("Calculating black hole LOS tau_v")
    ...
    def get_data_cube(
        ...
        Returns:
            SpectralCube:
                ...
                data cube.
        """
        tic("Computing stellar and blackhole spectral data cubes")
        ...
        if stellar_spectra is not None and blackhole_spectra is not None:
            toc("Computing stellar and blackhole spectral data cubes")
            return stellar_cube + blackhole_cube
        elif stellar_spectra is not None:
            toc("Computing stellar spectral data cube")
            return stellar_cube
        toc("Computing blackhole spectral data cube")
