...
- **SPS & photoionisation**: Libraries for stellar spectra—**BC03** [@bc03], **FSPS** [@fsps1; @fsps2], **BPASS** [@bpass], **Maraston** [@maraston05]—paired with dust/nebular models, plus **Cloudy** [@cloudy] or **MAPPINGS** [@MAPPINGS] for reprocessing. These serve as inputs to Synthesizer’s emission grids.
