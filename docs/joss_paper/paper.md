...
WJR, APV, and SMW acknowledge support from the Sussex Astronomy Centre STFC Consolidated Grant (ST/X001040/1). CCL was supported by the research environment and infrastructure of the Handley Lab at the University of Cambridge. APV acknowledges support from the Carlsberg Foundation (grant no CF20-0534). SB is supported by the Melbourne Research Scholarship and N D Goldsworthy Scholarship. LS and SN are supported by an STFC studentship. This work was supported by the Simons Collaboration on “Learning the Universe”.
