...
For performance, filter-specific integration artifacts are cached and reused when repeated photometry is evaluated on the same prepared wavelength/frequency grids.
